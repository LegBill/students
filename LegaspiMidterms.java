...
/*Student's Name: Bill Legaspi
  Year&Section:CS2B
*/

public class LegaspiMidterms {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("==============================");
        System.out.println("WELCOME TO BILL'S ARRAYLIST! \n Choose from below what you want to do:");
    ...
    {
        System.out.println("==============================");
        System.out.print("OK. Now, Type the name you would like to add: ");
                Scanner skaner1 = new Scanner(System.in);
                String ngalan1 = skaner1.nextLine();
                Names.add(ngalan1);
                System.out.print("Good! Now type his/her age: ");
